...
const TECH_FEATURES = [
  {
    title: 'SPC 石塑地板系統',
    body:
      '耐磨、防水、容易打理，特別適合香港潮濕天氣及家居／工商舖戶。配合專業找平及施工工序，減少空鼓、鬆脫及爆邊問題，同時屬於 pet-friendly，適合有小朋友及寵物的家庭。',
  },
  {
    title: '實木地板舖設及翻新',
    body:
      '由選材、收口至打磨與上油，提供新舖及舊木翻新服務。透過專業打磨及塗層處理，延長實木地板壽命，同時保留木材原有質感。',
  },
  {
    title: '地台自流平與工業地台油',
    body:
      '以自流平找平底層，改善高低不平及裂縫問題；再配合工業中心地台油處理，提升耐磨、抗壓及清潔表現，適合工廠大廈、倉儲及車位空間。',
  },
  {
    title: '戶外木地板及圍欄系統',
    body:
      '為天台、平台、花園及泳池邊提供耐候木地板及圍欄方案，兼顧美觀、防滑與排水，令戶外空間更宜居亦更易保養。',
  },
]
      ...
      <div className="px-6 md:px-16 py-24 max-w-4xl">
        ...
        <div className="space-y-16">
          {TECH_FEATURES.map((f, i) => (
            <div key={f.title} className="border-t border-beige/30 pt-10 grid md:grid-cols-3 gap-8">
              <div>
              ...
              <p className="md:col-span-2 font-sans text-charcoal/60 font-light leading-relaxed">{f.body}</p>
            </div>
          ))}
        </div>
      </div>
